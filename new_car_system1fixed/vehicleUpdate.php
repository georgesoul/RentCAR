								...
								if(is_numeric($hp))
									{
										...
										$query = "UPDATE vehicle SET StoreID='$sid', LicensePlate='$lplate', Model='$model', Constructor='$con', Type='$type', Year='$year', Kilometers='$km', CylinderCapacity='$cc', HorsePower='$hp', FuelType='$ftype', NextService='$nexts', LastService='$lasts', InsuranceExp='$expiry' WHERE VehicleID='$id'";
