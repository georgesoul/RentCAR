...
<?php
	...
	if(isset($_GET['id']))
	{
		...
		$query = "SELECT * FROM `e-mail.employee` WHERE SSN_emp='".$id."'";
	...
	if(isset($_POST["submit"]))
	{
		...
		if(strlen($id)==11)
		{
		  if(is_numeric($id))
		  {
					$query = "UPDATE `e-mail.employee` SET `E-mail`='$email' WHERE SSN_emp='$id'";
...
<div class="container">
<form method="post" action = "employeesemailUpdate.php">	
<?php echo $error;?>
